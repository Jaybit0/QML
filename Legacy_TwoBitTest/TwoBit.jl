...
rot2 = simpleRotationGate(cSize, evalGate=2, controlRange=5:6, maxRotationRad=pi/2)
rot2Inv = simpleRotationGateInv(cSize, evalGate=2, controlRange=5:6, maxRotationRad=pi/2)
